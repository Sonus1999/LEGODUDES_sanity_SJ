...
export default function ProductPage() {
    ...
    const handleCommentChange = (e) => {
        e.preventDefualt()
        setComment.apply(e.target. value)
    }

    const handleRatingChange = (e) => {
        e.preventDefualt()
        setRating.apply(e.target. value)
    }
                ...
                <article>
                    ...
                    <form>
                        ...
                        <p>
                            ...
                            <textarea name="comment" id="comment" onChange={handleCommentChange}/>
                        </p>
                        <p>
                            <label htmlFor="rating">Vudering:</label><br />
